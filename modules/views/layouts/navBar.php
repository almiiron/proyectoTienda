            ...
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                ...
                <li class="nav-item dropdown">
                    <a class="nav-link text-light" href="#" role="button" data-bs-toggle="dropdown"
                        aria-expanded="false">
                        Productos
                        <img src="/proyectoTienda/modules/views/layouts/img/icons8-chevron-para-abajo-50.png" class="imgNavBar"
            ...
            <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
                ...
                <li class="nav-item dropdown ms-1" id="dropdown-user">
                    <a class="btn btn-light" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                        ...
                        <img src="/proyectoTienda/modules/views/layouts/img/usuario.png" class="imgNavBar" alt=""
                            style="width:25px; height: 25px; margin-top:-5px;">
                        <img src="/proyectoTienda/modules/views/layouts/img/icons8-chevron-negro-para-abajo-50.png"

        ...
        <table class="table table-success table-striped" style="box-shadow: 1px 1px 10px 1px rgba(125, 125, 125, 0.5);">
            <thead style="height:80px;">
                <tr>
                    ...
                    <th class="bg-primary text-light text-center align-middle" scope="col">Nombre del Cliente</th>
                    <th class="bg-primary text-light text-center align-middle" scope="col">Apellido del Cliente</th>
            ...
            <tbody>
                <?php if ($lista): ?>
                    <?php foreach ($lista as $index => $fila): ?>
                        <tr>
                            ...
                            <td class="text-center">
                                <!-- Botón Modificar -->
                                <form action="http://localhost/proyectoTienda/page/mostrarModificar<?php echo $titulo; ?>"
                                    method="post" class="modal-modificar">
                                    <input type="hidden" name="idModificar" value="<?php echo $ids[$index]; ?>">
                                    <button type="submit" class="btn btn-warning" data-bs-toggle="modal"
                                        data-bs-placement="bottom" data-bs-target="#modificar<?php echo $contenedor; ?>">
                                        <!-- Modificar -->
                ...
                <?php else: ?>
                    <tr>
                        <td colspan="<?php echo count($encabezados) + 2; ?>" class="text-center">Nada que mostrar aquí.</td>
                    </tr>
                <?php endif; ?>
            </tbody>
        </table>

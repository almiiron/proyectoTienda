<div class="container my-5 ">
    <div class="table-responsive " style="height:400px;">
        <button type="button" class="btn btn-primary mb-1 text-center float-end" data-bs-toggle="modal"
            data-bs-placement="bottom" data-bs-title="Nuevo Cliente" data-bs-target="#cargarCliente" id="abrirModal">
        ...
        <?php require_once ('./modules/clientes/views/cargar-cliente.php'); ?>
        <table class="table table-striped">
            <thead style="height:80px;">
                <tr>
                    ...
                    <th class="custom-bg-secondary text-light text-center align-middle" scope="col">Nombre del Cliente
                    </th>
                    <th class="custom-bg-secondary text-light text-center align-middle" scope="col">Apellido del Cliente
                    </th>
            ...
            <tbody>
                <?php if ($lista): ?>
                    <?php foreach ($lista as $index => $fila): ?>
                        <tr>
                                ...
                                <td class="text-center custom-bg-tertiary">
                                    <?php if ($valor != 'Activo' && $valor != 'Inactivo') {
                                        ...
                                        <form method="post">
                                            ...
                                            <input type="hidden" name="metodo" id="metodoEstado" value="Cliente">
                            ...
                            <td class="text-center custom-bg-tertiary">
                                <!-- Botón Modificar -->
                                <form action="http://<?php echo IP_HOST; ?>/proyectoTienda/page/mostrarModificarCliente" method="post"
                                    class="modal-modificar">
                                    <input type="hidden" name="idModificar" value="<?php echo $ids[$index]; ?>">
                                    <button type="submit" class="btn btn-warning" data-bs-toggle="modal"
                                        data-bs-placement="bottom" data-bs-target="#modificarCliente">
                                        <!-- Modificar -->
                ...
                <?php else: ?>
                    <tr>
                        <td colspan="6" class="text-center custom-bg-tertiary">Nada que mostrar aquí.</td>
                    </tr>
                <?php endif; ?>
            </tbody>
        </table>

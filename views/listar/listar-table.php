<div class="container my-5 ">
    <div class="table-responsive ">
        <button type="button" class="btn btn-primary mb-1 text-center float-end" data-bs-toggle="modal"
            ...
            <img src="/proyectoTienda/views/layouts/img/icons8-añadir-50.png" alt=""
                                    ...
                                    <?php if ($valor != 'Activo' && $valor != 'Inactivo') {
                                        ...
                                        ?>
                                            ...
                                            <form method="post">
                                                ...
                                                <input type="hidden" name="metodo" id="metodoEstado" value="<?php echo $titulo; ?>">
                            ...
                            <td class="text-center">
                                ...
                                <form action="http://localhost/proyectoTienda/page/mostrarModificar<?php echo $titulo; ?>"
                                    ...
                                    <button type="submit" class="btn btn-warning" data-bs-toggle="modal"
                                        ...
                                        data-bs-target="#modificar<?php echo $contenedor; ?>">
                                        <!-- Modificar -->
